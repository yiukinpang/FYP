class TextMessage {
  ...
  createElement() {
    ...
    this.element.innerHTML = `
      <p class="TextMessage_p" id="TextMessage"></p>
      <button class="Select_button" id="selectA">A</button>
      <button class="Select_button" id="selectB">B</button>
      <button class="Select_button" id="selectC">C</button>
      <button class="Select_button" id="selectD">D</button>
    ...
    this.element.querySelector(".Select_button").addEventListener("click", () => {
